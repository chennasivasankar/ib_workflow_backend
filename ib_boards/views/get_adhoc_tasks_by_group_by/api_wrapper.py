...
def api_wrapper(*args, **kwargs):
    ...
    try:
        from ib_boards.views.get_adhoc_tasks_by_group_by.request_response_mocks \
    ...
    test_case = {
        "path_params": {},
        "query_params": {'project_id': 'string', 'limit': 880, 'offset': 442, 'group_limit': 10, 'group_offset': 786},
        "header_params": {},
        "body": body,
    ...
    response_tuple = mock_response(
        ...
        operation_name="get_adhoc_tasks_by_group_by",
