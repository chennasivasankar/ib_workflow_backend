...
def api_wrapper(*args, **kwargs):
    ...
    try:
        from ib_boards.views.get_adhoc_tasks_by_group_ids.request_response_mocks \
    ...
    test_case = {
        "path_params": {},
        "query_params": {'project_id': 'string', 'limit': 641, 'offset': 554, 'group1_id': 'string', 'group2_id': 'string'},
        "header_params": {},
        "body": body,
    ...
    response_tuple = mock_response(
        ...
        operation_name="get_adhoc_tasks_by_group_ids",
