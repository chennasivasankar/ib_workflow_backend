...
from ib_boards.tests.factories.models import ColumnFactory, ColumnPermissionFactory, BoardFactory
...
class TestGetColumnIdsForBoard:
    ...
    def test_get_column_ids_for_board(self, create_columns):
        ...
        expected_column_ids = ["COLUMN_ID_1", "COLUMN_ID_2", "COLUMN_ID_3", "COLUMN_ID_4"]
