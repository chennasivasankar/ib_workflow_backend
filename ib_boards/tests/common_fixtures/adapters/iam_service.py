...
def mock_validate_project_id(mocker, project_id: str):
    mock = mocker.patch(
        'ib_boards.adapters.iam_service.IamService.validate_project_id'
    )
    mock.return_value = True
    return mock

def mock_validate_project_ids(mocker, project_id: str):
    mock = mocker.patch(
