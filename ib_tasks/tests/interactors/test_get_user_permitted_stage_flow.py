...
class TestGetPermittedTemplateStageFlowToUser(StorageMockClass):
    ...
    def test_invalid_template_raises_exception(
        ...
        # Act
        interactor.get_permitted_template_stage_flow_to_user_wrapper(
    ...
    def test_given_valid_details_returns_details(
        ...
        # Assert
        stage_storage.get_user_permitted_stages_in_template.assert_called_once_with(
            template_id=template_id, user_roles=user_roles
        )
        action_storage_mock.get_user_permitted_action_ids_given_stage_ids.assert_called_once_with(
    ...
    def set_up_storage(self, task_template_storage,
        ...
        stage_storage.get_user_permitted_stages_in_template\
            .return_value = stage_dtos
        action_storage_mock.get_user_permitted_action_ids_given_stage_ids\
