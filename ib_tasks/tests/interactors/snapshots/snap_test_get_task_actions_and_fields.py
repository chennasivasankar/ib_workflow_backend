...
snapshots['TestGetFieldsAndActionsInteractor.test_get_actions_and_fields_when_two_stages_has_same_task_id response'] = [
...
snapshots['TestGetFieldsAndActionsInteractor.test_get_actions_and_fields_when_two_tasks_are_in_same_stage response'] = [
    GenericRepr("GetTaskStageCompleteDetailsDTO(task_id=1, stage_id='stage_id_1', field_dtos=[FieldDetailsDTO(field_type='Drop down', field_id='FIELD-ID-1', key='key', value='value'), FieldDetailsDTO(field_type='Drop down', field_id='FIELD-ID-2', key='key', value='value')], action_dtos=[ActionDetailsDTO(action_id=1, name='name_1', stage_id='stage_id_1', button_text='button_text_1', button_color=None), ActionDetailsDTO(action_id=2, name='name_2', stage_id='stage_id_1', button_text='button_text_2', button_color=None)])"),
    GenericRepr("GetTaskStageCompleteDetailsDTO(task_id=2, stage_id='stage_id_1', field_dtos=[FieldDetailsDTO(field_type='Drop down', field_id='FIELD-ID-3', key='key', value='value'), FieldDetailsDTO(field_type='Drop down', field_id='FIELD-ID-4', key='key', value='value')], action_dtos=[ActionDetailsDTO(action_id=1, name='name_1', stage_id='stage_id_1', button_text='button_text_1', button_color=None), ActionDetailsDTO(action_id=2, name='name_2', stage_id='stage_id_1', button_text='button_text_2', button_color=None)])")
]
