...
class TestGetFieldsAndActionsInteractor:
    ...
    def test_get_user_permitted_fields_and_actions(
            ...
            get_actions_dtos, get_field_ids,
    ...
    def test_with_invalid_task_ids_raises_exception(self, action_storage,
                                                    stage_storage,
                                                    task_storage,
                                                    field_storage,
                                                    mocker,
    ...
    def test_with_invalid_stage_ids_raises_exception(self, action_storage,
                                                     stage_storage,
                                                     task_storage,
                                                     field_storage,
                                                     mocker,
    ...
    def test_get_actions_and_fields_when_task_has_no_actions_or_fields_returns_empty_list(
        ...
        stage_storage.get_stage_details.return_value = \
            task_template_stages_dtos
        prepare_actions_for_get_task_fields_and_actions(mocker, [])
        prepare_fields_for_get_task_fields_and_actions(mocker, [],
                                                       task_with_no_fields)
