"""
test with invalid country ids for searchable raise exceception
"""
...
from ib_tasks.adapters.searchable_details_service import \
    SearchableDetailsService, InvalidCountryIdsException
...
class TestCase07GetTaskAPITestCase(TestUtils):
    APP_NAME = APP_NAME
