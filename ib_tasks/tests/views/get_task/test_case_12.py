"""
test with users (assignees) not exists for teams raise exception
"""
...
class TestCase12GetTaskAPITestCase(TestUtils):
    APP_NAME = APP_NAME
    ...
    def test_case(self, user_ids_mock, user_id_team_details_dtos_mock,
        ...
        exception_object = UsersNotExistsForGivenTeamsException(user_ids)
