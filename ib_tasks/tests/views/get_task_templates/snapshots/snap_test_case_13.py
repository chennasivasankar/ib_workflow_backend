...
snapshots['TestCase13GetTaskTemplatesAPITestCase.test_case status_code'] = '200'

snapshots['TestCase13GetTaskTemplatesAPITestCase.test_case body'] = [
    {
        'actions': [
            {
                'action_id': 1,
