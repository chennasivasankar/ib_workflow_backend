"""
test with gofs not related to transition template raises exception
"""
import pytest
...
class TestCase10CreateTransitionChecklistAPITestCase(TestUtils):
    APP_NAME = APP_NAME
    ...
    def setup(self):
        ...
        FieldFactory.create_batch(size=3, field_id=factory.Iterator(field_ids))
