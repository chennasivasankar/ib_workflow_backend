"""
test with invalid value for gof selector field raises exception
"""
import pytest
...
class TestCase22CreateTransitionChecklistAPITestCase(TestUtils):
    APP_NAME = APP_NAME
    ...
    def setup(self, mocker):
        ...
        field_obj = FieldFactory.create(
            ...
            '{"name": "Company", "gof_ids": ["FIN_VENDOR_COMPANY_DETAILS"]}]'
        )
