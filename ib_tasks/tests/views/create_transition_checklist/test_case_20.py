...
class TestCase20CreateTransitionChecklistAPITestCase(TestUtils):
    APP_NAME = APP_NAME
    ...
    @pytest.mark.parametrize('password_value', ["iBHubs", "@priB"])
    def test_case(self, snapshot, password_value):
        body = {
            'task_id': 'IBWF-1',
