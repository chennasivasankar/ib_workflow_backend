"""
test with invalid value for multi select labels field raises exception
"""
import pytest
...
class TestCase26CreateTransitionChecklistAPITestCase(TestUtils):
    APP_NAME = APP_NAME
