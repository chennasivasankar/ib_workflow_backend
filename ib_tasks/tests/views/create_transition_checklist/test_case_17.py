"""
test with invalid value for email field raises exception
"""
import pytest
...
class TestCase17CreateTransitionChecklistAPITestCase(TestUtils):
    APP_NAME = APP_NAME
    ...
    @pytest.mark.parametrize(
        'email_value', ["rajesh@ibhubs@.com", ".kumar@gmail@com"])
    def test_case(self, snapshot, email_value):
        body = {
            'task_id': 'IBWF-1',
