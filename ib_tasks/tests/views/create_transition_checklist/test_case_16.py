"""
test with invalid value for url field raises exception
"""
import pytest
...
class TestCase16CreateTransitionChecklistAPITestCase(TestUtils):
    APP_NAME = APP_NAME
    ...
    @pytest.mark.parametrize(
        'url_value', ["www.google.com", "http://google"])
    def test_case(self, snapshot, url_value):
        body = {
            'task_id': 'IBWF-1',
