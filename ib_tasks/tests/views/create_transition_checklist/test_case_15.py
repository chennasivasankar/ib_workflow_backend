...
class TestCase15CreateTransitionChecklistAPITestCase(TestUtils):
    APP_NAME = APP_NAME
    ...
    @pytest.mark.parametrize('phone_number_value', ["679820", "162789hdsb"])
    def test_case(self, snapshot, phone_number_value):
        body = {
            'task_id': 'IBWF-1',
            ...
            'transition_checklist_gofs': [
                {
                    ...
                    'gof_fields': [
                        {
                            'field_id': 'field_1',
                            'field_response': phone_number_value
                        }
                    ]
                }
            ]
