"""
test when user does not have write permission for field raises exception
"""
import pytest
...
class TestCase13CreateTransitionChecklistAPITestCase(TestUtils):
    APP_NAME = APP_NAME
