"""
test with missed due date but task delay reason is not updated
"""
import datetime
...
class TestCase12SaveAndActOnATaskAPITestCase(TestUtils):
    APP_NAME = APP_NAME
    ...
    def setup(self, mocker):
        ...
        task = TaskFactory.create(
            ...
            start_date=datetime.datetime(2020, 8, 9, 12, 0, 0),
            due_date=datetime.datetime(2020, 9, 5, 12, 0, 0)
        )
