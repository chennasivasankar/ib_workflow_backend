...
snapshots['TestCase25SaveAndActOnATaskAPITestCase.test_case[number] body'] = {
    ...
    'response': 'Invalid number: number for field: DISPLAY_NAME-0! Number should only consists digits'
}
...
snapshots['TestCase25SaveAndActOnATaskAPITestCase.test_case[one2] body'] = {
    'http_status_code': 400,
    'res_status': 'INVALID_NUMBER_VALUE',
    'response': 'Invalid number: one2 for field: DISPLAY_NAME-0! Number should only consists digits'
}
...
snapshots['TestCase25SaveAndActOnATaskAPITestCase.test_case[@2] body'] = {
    'http_status_code': 400,
    'res_status': 'INVALID_NUMBER_VALUE',
    'response': 'Invalid number: @2 for field: DISPLAY_NAME-0! Number should only consists digits'
}
