"""
test without start datetime when action type is not NO_VALIDATIONS
"""
...
class TestCase08SaveAndActOnATaskAPITestCase(TestUtils):
    APP_NAME = APP_NAME
    ...
    def test_case(self, snapshot):
        body = {
            ...
            "start_datetime": "2020-09-05 12:00:00",
            "due_datetime": None,
            "priority": "HIGH",
            "stage_assignee": {
                "stage_id": 1,
