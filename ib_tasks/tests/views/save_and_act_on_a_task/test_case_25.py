...
class TestCase25SaveAndActOnATaskAPITestCase(TestUtils):
    APP_NAME = APP_NAME
    ...
    @pytest.mark.parametrize(
        "weak_password", ["strong_password", "password123", "#2pass="])
    @freeze_time("2020-09-09 12:00:00")
    @pytest.mark.django_db
    def test_case(self, snapshot, weak_password):
        body = {
            "task_id": "IBWF-1",
            "action_id": 1,
            "title": "updated_title",
