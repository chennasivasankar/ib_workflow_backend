...
class TestCase44SaveAndActOnATaskAPITestCase(TestUtils):
    ...
    def setup(self, mocker):
        ...
        action_stage = models.StageFactory(
            id=3, task_template_id=template.template_id)
        models.CurrentTaskStageModelFactory.create(task=task, stage=action_stage)
        ...
        models.StagePermittedRolesFactory.create(stage=action_stage,
                                                 role_id="FIN_PAYMENT_REQUESTER")
