"""
test with duplicate fields of a gof
"""
...
class TestCase17SaveAndActOnATaskAPITestCase(TestUtils):
    APP_NAME = APP_NAME
    ...
    def setup(self, mocker):
        ...
        field = FieldFactory.create(field_id=field_id)
            ...
            "task_gofs": [
                {
                    ...
                    "gof_fields": [
                        ...
                        {
                            "field_id": "FIELD_ID-1",
                            "field_response": "duplicate response"
                        }
                    ]
                }
            ]
