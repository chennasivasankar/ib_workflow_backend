"""
test with invalid project task template
"""
import pytest
...
class TestCase07CreateSubTaskAPITestCase(TestUtils):
    APP_NAME = APP_NAME
    ...
    def setup(self, api_user, mocker):
        ...
        ProjectTaskTemplateFactory.create(
            project_id=template_project_id, task_template=template_obj)
