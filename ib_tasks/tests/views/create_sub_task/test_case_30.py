"""
test with invalid value for gof selector
name for gof_selector field raises exception
"""
import pytest
...
class TestCase30CreateSubTaskAPITestCase(TestUtils):
    APP_NAME = APP_NAME
    ...
    def setup(self, api_user, mocker):
        ...
        field = FieldFactory.create(
            field_id=field_id, gof=gof, field_type=FieldTypes.GOF_SELECTOR.value,
            field_values='[{"name": "dragons", "gof_ids": ["Drogon", '
                         '"Big Drogon"]}]')
