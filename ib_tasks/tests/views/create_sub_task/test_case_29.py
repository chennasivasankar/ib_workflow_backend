"""
test with invalid value for dropdown field raises exception
"""
import pytest
...
class TestCase29CreateSubTaskAPITestCase(TestUtils):
    APP_NAME = APP_NAME
    ...
    def setup(self, api_user, mocker):
        ...
        field = FieldFactory.create(
            field_id=field_id, gof=gof, field_type=FieldTypes.DROPDOWN.value,
            field_values='["Drogon", "Big Drogon"]')
    ...
    @pytest.mark.parametrize('dropdown_choice', ['viserys', 'aegon'])
    @pytest.mark.django_db
    def test_case(self, snapshot, dropdown_choice):
        body = {
            "project_id": "project_1",
            ...
            "task_gofs": [
                {
                    ...
                    "gof_fields": [
                        {
                            "field_id": "FIN_PAYMENT_REQUESTER_FIELD",
                            "field_response": dropdown_choice
                        }
                    ]
                }
            ]
