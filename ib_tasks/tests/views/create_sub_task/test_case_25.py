"""
test with invalid email pattern for email field raises exception
"""
import pytest
...
class TestCase25CreateSubTaskAPITestCase(TestUtils):
    APP_NAME = APP_NAME
    ...
    @pytest.mark.parametrize('email', ['www.google.@com', 'http://google'])
    @pytest.mark.django_db
    def test_case(self, snapshot, email):
        body = {
            "project_id": "project_1",
