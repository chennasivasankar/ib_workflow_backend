...
snapshots['TestCase21CreateTaskAPITestCase.test_case[iB] body'] = {
    ...
    'response': 'Given a weak password: iB for field: FIELD_ID-0! Try with at least 6 characters including special characters'
}
...
snapshots['TestCase21CreateTaskAPITestCase.test_case[iB_8293] body'] = {
    'http_status_code': 400,
    'res_status': 'NOT_A_STRONG_PASSWORD',
    'response': 'Given a weak password: iB_8293 for field: FIELD_ID-0! Try with at least 6 characters including special characters'
}
