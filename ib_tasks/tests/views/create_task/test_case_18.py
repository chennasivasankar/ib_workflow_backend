"""
test with invalid url pattern for url field raises exception
"""
import datetime
...
class TestCase18CreateTaskAPITestCase(TestUtils):
    APP_NAME = APP_NAME
    ...
    def setup(self, mocker):
        ...
        field_obj = FieldFactory.create(
            gof=gof_obj, field_type=FieldTypes.URL.value)
    ...
    @pytest.mark.parametrize('url', ['www.google.com', 'http://google'])
    @freezegun.freeze_time(datetime.datetime(2020, 8, 31, 5, 4, 54))
    def test_case(self, snapshot, url):
        body = {
            "project_id": "project_1",
            "task_template_id": "template_1",
            "action_id": 1,
