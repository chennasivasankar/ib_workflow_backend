"""
test with invalid file url for file uploader field raises exception
"""
import datetime
...
class TestCase34CreateTaskAPITestCase(TestUtils):
    APP_NAME = APP_NAME
    ...
    def setup(self, mocker):
        ...
        field_obj = FieldFactory.create(
            gof=gof_obj, field_type=FieldTypes.FILE_UPLOADER.value,
