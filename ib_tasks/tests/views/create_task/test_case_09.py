"""
test with same gof order for different gofs is same raises exception
"""
import datetime
...
class TestCase09CreateTaskAPITestCase(TestUtils):
    APP_NAME = APP_NAME
    ...
    @freezegun.freeze_time(datetime.datetime(2020, 7, 31, 5, 4, 54))
