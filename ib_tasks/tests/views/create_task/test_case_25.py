"""
test with invalid value for radio group field raises exception
"""
import datetime
...
class TestCase25CreateTaskAPITestCase(TestUtils):
    APP_NAME = APP_NAME
    ...
    def setup(self, mocker):
        ...
        field_obj = FieldFactory.create(
            gof=gof_obj, field_type=FieldTypes.RADIO_GROUP.value,
            field_values="[\"Mr\", \"Mrs\"]")
