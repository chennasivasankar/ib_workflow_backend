"""
test with invalid value for password field raises exception
"""
import datetime
...
class TestCase21CreateTaskAPITestCase(TestUtils):
    APP_NAME = APP_NAME
    ...
    def setup(self, mocker):
        ...
        field_obj = FieldFactory.create(
            gof=gof_obj, field_type=FieldTypes.PASSWORD.value)
    ...
    @pytest.mark.parametrize('password', ['iB', 'iB_8293'])
    @freezegun.freeze_time(datetime.datetime(2020, 8, 31, 5, 4, 54))
    def test_case(self, snapshot, password):
        body = {
            "project_id": "project_1",
            "task_template_id": "template_1",
            "action_id": 1,
