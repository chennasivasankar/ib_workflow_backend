"""
test with invalid image format for image uploader field raises exception
"""
import datetime
...
class TestCase31CreateTaskAPITestCase(TestUtils):
    APP_NAME = APP_NAME
    ...
    def setup(self, mocker):
        ...
        field_obj = FieldFactory.create(
            gof=gof_obj, field_type=FieldTypes.IMAGE_UPLOADER.value,
            ...
            "task_gofs": [
                {
                    ...
                    "gof_fields": [
                        {
                            "field_id": "FIELD_ID-0",
                            "field_response": "http://google.com/iB.mp4"
                        }
                    ]
                }
            ]
