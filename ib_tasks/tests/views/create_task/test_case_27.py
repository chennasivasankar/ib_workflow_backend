"""
test with invalid value for multi select field raises exception
"""
import datetime
...
class TestCase27CreateTaskAPITestCase(TestUtils):
    APP_NAME = APP_NAME
    ...
    def setup(self, mocker):
        ...
        field_obj = FieldFactory.create(
            gof=gof_obj, field_type=FieldTypes.MULTI_SELECT_FIELD.value,
            field_values="[\"Mr\", \"Mrs\"]")
