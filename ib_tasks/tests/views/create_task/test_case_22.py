"""
test with invalid value for float field raises exception
"""
import datetime
...
class TestCase22CreateTaskAPITestCase(TestUtils):
    APP_NAME = APP_NAME
    ...
    def setup(self, mocker):
        ...
        field_obj = FieldFactory.create(
            gof=gof_obj, field_type=FieldTypes.FLOAT.value)
    ...
    @pytest.mark.parametrize('float_value', ['iB', '500_iB'])
    @freezegun.freeze_time(datetime.datetime(2020, 8, 31, 5, 4, 54))
    def test_case(self, snapshot, float_value):
        body = {
            "project_id": "project_1",
            "task_template_id": "template_1",
            "action_id": 1,
