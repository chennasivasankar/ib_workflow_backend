"""
test when user has only read permissions to fields returns empty gofs
"""
import pytest
...
class TestCase07GetTransitionTemplateAPITestCase(TestUtils):
    APP_NAME = APP_NAME
    ...
    def setup(self, mocker):
        ...
        FieldRoleFactory.create_batch(
            ...
            permission_type=factory.Iterator([PermissionTypes.READ.value])
        )
