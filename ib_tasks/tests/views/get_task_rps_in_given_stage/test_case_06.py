...
def get_user_dtos_given_user_ids_mock(mocker):
    ...
    user_1 = UserDetailsDTOFactory()
    user_2 = UserDetailsDTOFactory()
    user_dtos = [user_2, user_1]
    mock.return_value = user_dtos
    return mock


class TestCase06GetTaskRpsInGivenStageAPITestCase(TestUtils):
    APP_NAME = APP_NAME
    ...
    def setup(self, api_user, mocker):
        ...
        UserRpInTaskStageFactory.create_batch(size=2, task=tasks[0],
                                              stage_id=1)
