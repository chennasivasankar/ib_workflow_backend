...
snapshots['TestGetTaskPresenterImplementation.test_raise_exception_for_invalid_city_ids exception_object'] = b'{"response": "Something went wrong contact Admin", "http_status_code": 404, "res_status": "SEARCHABLE_RECORDS_NOT_FOUND"}'

snapshots['TestGetTaskPresenterImplementation.test_raise_exception_for_invalid_state_ids exception_object'] = b'{"response": "Something went wrong contact Admin", "http_status_code": 404, "res_status": "SEARCHABLE_RECORDS_NOT_FOUND"}'
