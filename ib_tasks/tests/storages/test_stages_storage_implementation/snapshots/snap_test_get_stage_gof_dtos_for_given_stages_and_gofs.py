...
snapshots['TestGetStageGoFDTOsForGivenStagesAndGoFs.test_when_stage_gofs_exists_returns_stage_gof_dtos stage_gofs'] = [
    GenericRepr("StageIdWithGoFIdDTO(stage_id=1, gof_id='gof_1')"),
    GenericRepr("StageIdWithGoFIdDTO(stage_id=1, gof_id='gof_3')"),
    GenericRepr("StageIdWithGoFIdDTO(stage_id=2, gof_id='gof_2')")
]
