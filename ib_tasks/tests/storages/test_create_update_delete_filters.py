...
class TestFilterStorageImplementation:
    ...
    def test_get_enabled_filters_dto_to_user_with(self, snapshot, storage):
        # Arrange
        user_id = '1'
        FilterConditionFactory.reset_sequence()
        ...
        filter_2 = FilterFactory(created_by=user_id)
    ...
    def test_get_enabled_filters_dto_to_user_with_all_filters_enabled(self, snapshot, storage):
        # Arrange
        user_id = '1'
        FilterConditionFactory.reset_sequence()
        FilterFactory.reset_sequence()
    ...
    def test_get_enabled_filters_dto_to_user_with_no_filters_enabled(self, snapshot, storage):
        # Arrange
        user_id = '1'
        FilterConditionFactory.reset_sequence()
        FilterFactory.reset_sequence()
