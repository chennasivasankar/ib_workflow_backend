...
snapshots['TestAddDueDelayDetails.test_add_due_delay_details_given_details task_due_datetime'] = GenericRepr("<CommonCustomQuerySet [{'id': 1, 'tasklog__user_id': '123e4567-e89b-12d3-a456-426614174000', 'due_date': FakeDatetime(2020, 8, 10, 7, 0, tzinfo=<UTC>)}]>")
