...
class TestGetTaskStageAssugneesWithoutHavingLeftAtStatus:
   def test_get_task_stages_having_assignees_without_having_left_at_status(self):
       # Arrange
       ...
       # Act
       actual_result = storage.get_task_stages_having_assignees_without_having_left_at_status(
           db_stage_ids=[1,2,3],
           task_id=1)
       # Assert
