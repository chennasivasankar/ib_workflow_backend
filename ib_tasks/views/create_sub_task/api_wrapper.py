...
from ib_tasks.views.create_sub_task.validator_class import ValidatorClass
...
from ib_tasks.interactors.task_dtos import FieldValuesDTO, BasicTaskDetailsDTO, \
    CreateSubTaskDTO
from ib_tasks.presenters.create_sub_task_presenter_implementation import \
...
def api_wrapper(*args, **kwargs):
    ...
    task_dto = CreateSubTaskDTO(
        basic_task_details_dto=basic_task_details_dto,
        gof_fields_dtos=task_gofs_dtos, parent_task_id=parent_task_id)
