...
def api_wrapper(*args, **kwargs):
    ...
    try:
        from ib_tasks.views.get_stage_possible_assignees_of_a_task.request_response_mocks \
    ...
    test_case = {
        "path_params": {'task_id': 876, 'stage_id': 'string'},
        "query_params": {'user_search_type': 'USER', 'limit': 271, 'offset': 162, 'search_query': 'string'},
        "header_params": {},
        "body": body,
    ...
    response_tuple = mock_response(
        ...
        operation_name="get_stage_possible_assignees_of_a_task",
