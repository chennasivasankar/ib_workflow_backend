...
from ib_tasks.interactors.storage_interfaces.fields_dtos import \
    (FieldCompleteDetailsDTO, FieldDTO, UserFieldPermissionDTO,
     ...
     FieldNameWithGoFDisplayNameDTO, FieldTypeDTO, FieldWritePermissionRolesDTO)
...
class FieldsStorageImplementation(FieldsStorageInterface):
    ...
    def get_fields_display_names_with_gof_display_name(
            self, field_ids: List[str]) -> List[FieldNameWithGoFDisplayNameDTO]:
    ...
    ) -> List[FieldNameWithGoFDisplayNameDTO]:
    ...
    def get_field_ids_for_given_task_template_ids(self,
        ...
        task_field_objs = TaskTemplateGoFs.objects.filter(
                task_template_id__in=task_template_ids).values(
                'task_template_id',
                'gof__field')
    ...
    def _convert_user_field_permission_details_to_dtos(
        ...
        user_field_permission_dtos = [
                UserFieldPermissionDTO(
                        ...
                        permission_type=user_field_permission[
                            'permission_type']
                )
    ...
    def validate_user_roles_with_field_ids_roles(
        ...
        invalid_user = not (updated_user_role == fields_user_roles or set(
                fields_user_roles).issubset(
    ...
    def get_field_display_names(self, field_ids: List[str]) -> List[
        FieldDisplayNameDTO]:
