...
from ib_tasks.adapters.dtos import AssigneeDetailsDTO, ColumnStageDTO
...
class SaveAndActOnATaskPresenterImplementation(
    ...
    def get_save_and_act_on_task_response(
        ...
        task_complete_details_dto = task_overview_details_dto.task_complete_details_dto
        task_current_stage_details_dto = task_overview_details_dto.task_current_stage_details_dto
        all_tasks_overview_dto = task_overview_details_dto.all_tasks_overview_details_dto
