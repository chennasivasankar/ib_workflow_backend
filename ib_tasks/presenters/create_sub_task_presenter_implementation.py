...
class CreateSubTaskPresenterImplementation(
    ...
    def get_create_sub_task_response(
        ...
        created_task_display_id = complete_task_details.created_task_display_id
        task_current_stage_details_dto = \
        complete_task_details.task_current_stages_details_dto
        all_tasks_overview_dto = \
        complete_task_details.all_tasks_overview_details_dto
