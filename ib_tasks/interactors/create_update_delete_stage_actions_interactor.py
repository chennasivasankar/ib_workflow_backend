...
class CreateUpdateDeleteStageActionsInteractor:
    ...
    def _append_create_and_update_stage_dto(
            self, db_action_names, stage_actions_dto,
            create_stage_actions, update_stage_actions):
    ...
    def _validations_for_button_texts(self, actions_dto: List[ActionDto]):
    ...
    @staticmethod
    def _get_stage_button_texts(actions_dto: List[ActionDto]):
    ...
    def _validations_for_stage_ids(self, stage_ids: List[str]):
        db_stage_ids = self.stage_storage.get_db_stage_ids(stage_ids=stage_ids)
    ...
    @staticmethod
    def _get_stage_ids(actions_dto: List[ActionDto]):
        stage_ids = [
            action_dto.stage_id
            for action_dto in actions_dto
        ]
