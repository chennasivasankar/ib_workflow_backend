...
class ActOnTaskInteractor(GetTaskIdForTaskDisplayIdMixin,
                          ValidationMixin):
    ...
    def act_on_task_wrapper(
        ...
        try:
            ...
            all_tasks_overview_dto = self.act_on_task(task_id)
    ...
    def act_on_task(self, task_id: int):
