...
class GetTaskStageLogicSatisfiedNextStagesGivenStatusVarsInteractor:
    ...
    def get_task_stage_logic_satisfied_next_stages(
        ...
        stage_display_value_dtos = self.storage \
            .get_task_template_stage_logic_to_task(task_id=task_id)
    ...
    def _get_stage_logic_satisfied_stages(
            ...
            status_variable_dict: Dict[str, str], stage_value_dict: Dict[str,
                                                                         int]):

        logic_satisfied_stages = []
        for status_stage_dto in status_stage_dtos:
            self._calculate_display_logic(status_stage_dto,
    ...
    def _calculate_display_logic(self, status_stage_dto: StatusOperandStageDTO,
        ...
        if status_stage_dto.operator == "==":
            self._calculate_direct_logic(status_stage_dto,
                                         status_variable_dict,
                                         logic_satisfied_stages)
        else:
            self._calculate_indirect_logic(status_stage_dto,
                                           status_variable_dict,
                                           logic_satisfied_stages,
                                           stage_value_dict)
    ...
    def _calculate_indirect_logic(self,
                                  status_stage_dto: StatusOperandStageDTO,
                                  status_variable_dict: Dict[str, Any],
                                  logic_satisfied_stages: List[str],
                                  stage_value_dict: Dict[str, int]):
        operator_dict = self._get_operator_dict()
    ...
    def _get_task_status_variable_dict(
