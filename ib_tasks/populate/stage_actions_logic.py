...
def PR_PENDING_RP_APPROVAL_Submit_for_Approval(task_dict, global_constants, stage_value_dict):
	task_dict["status_variables"]["Status1"] = "PR_PENDING_RP_APPROVAL"
	return task_dict


def PR_PENDING_RP_APPROVAL_Discard(task_dict, global_constants, stage_value_dict):
	task_dict["status_variables"]["Status1"] = "PR_DISCARDED"
	return task_dict
