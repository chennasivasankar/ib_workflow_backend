...
def EMP_DRAFTS_Submit_for_Enrolling(task_dict, global_constants, stage_value_dict):
	task_dict["status_variables"]["Status1"] = "EMP_PENDING_SELECTION_PROCESS"
	return task_dict


def EMP_PENDING_SELECTION_PROCESS_Selected(task_dict, global_constants, stage_value_dict):
	task_dict["status_variables"]["Status1"] = "EMP_PENDING_MENTOR_DISCUSSION"
	return task_dict


def EMP_PENDING_SELECTION_PROCESS_Reject(task_dict, global_constants, stage_value_dict):
	task_dict["status_variables"]["Status1"] = "EMP_REJECTED"
	return task_dict


def EMP_PENDING_MENTOR_DISCUSSION_Interested(task_dict, global_constants, stage_value_dict):
	task_dict["status_variables"]["Status1"] = "EMP_PENDING_PAYMENT_INFORMATION"
	return task_dict


def EMP_PENDING_MENTOR_DISCUSSION_Not_Interested(task_dict, global_constants, stage_value_dict):
	task_dict["status_variables"]["Status1"] = "EMP_REJECTED"
	return task_dict


def EMP_PENDING_PAYMENT_INFORMATION_Submit(task_dict, global_constants, stage_value_dict):
...
def EMP_PENDING_FINAL_SELECTION_Selected(task_dict, global_constants, stage_value_dict):
	task_dict["status_variables"]["Status1"] = "EMP_PENDING_ONBOARDING_SIGNING_AGREEMENTS"
	return task_dict


def EMP_PENDING_FINAL_SELECTION_Reject(task_dict, global_constants, stage_value_dict):
	task_dict["status_variables"]["Status1"] = "EMP_REJECTED"
	return task_dict


def EMP_PENDING_ONBOARDING_SIGNING_AGREEMENTS_Submit(task_dict, global_constants, stage_value_dict):
	task_dict["status_variables"]["Status1"] = "EMP_PENDING_BACKGROUND_CHECK"
	return task_dict


def EMP_PENDING_BACKGROUND_CHECK_Cleared(task_dict, global_constants, stage_value_dict):
	task_dict["status_variables"]["Status1"] = "PENDING_EMPLOYEE_ALIGNMENT_VALIDATION"
	return task_dict


def EMP_PENDING_BACKGROUND_CHECK_Not_Cleared(task_dict, global_constants, stage_value_dict):
	task_dict["status_variables"]["Status1"] = "EMP_REJECTED"
	return task_dict


def PENDING_EMPLOYEE_ALIGNMENT_VALIDATION_Aligned(task_dict, global_constants, stage_value_dict):
	task_dict["status_variables"]["Status1"] = "PENDING_EMPLOYEE_ASSIGNMENT_COMPLETION"
	return task_dict


def PENDING_EMPLOYEE_ASSIGNMENT_COMPLETION_Submit(task_dict, global_constants, stage_value_dict):
	task_dict["status_variables"]["Status1"] = "PENDING_SALARY_DEPOSIT"
	return task_dict


def PENDING_SALARY_DEPOSIT_Submit(task_dict, global_constants, stage_value_dict):
	task_dict["status_variables"]["Status1"] = "PENDING_WEEKLY_TARGET_COMPLETION"
	return task_dict


def PENDING_WEEKLY_TARGET_COMPLETION_Submit(task_dict, global_constants, stage_value_dict):
	task_dict["status_variables"]["Status1"] = "PENDING_EXTRA_ASSIGNMENT_COMPLETION"
	return task_dict


def PENDING_EXTRA_ASSIGNMENT_COMPLETION_Submit(task_dict, global_constants, stage_value_dict):
	task_dict["status_variables"]["Status1"] = "PENDING_LEARNINGS_FOR_WEEK"
	return task_dict


def PENDING_LEARNINGS_FOR_WEEK_Submit(task_dict, global_constants, stage_value_dict):
	task_dict["status_variables"]["Status1"] = "PENDING_WEEKLY_TARGET_COMPLETION"
	return task_dict


def PR_CREATE_EMPLOYEE_FORM_Save_as_Draft(task_dict, global_constants, stage_value_dict):
	task_dict["status_variables"]["Status1"] = "EMP_DRAFTS"
	return task_dict


def PR_CREATE_EMPLOYEE_FORM_Submit_for_Enrolling(task_dict, global_constants, stage_value_dict):
	task_dict["status_variables"]["Status1"] = "EMP_PENDING_SELECTION_PROCESS"
	return task_dict
