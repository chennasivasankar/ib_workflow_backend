...
class CreateChecklistItemInteractor:
    ...
    def create_checklist_item(self,
                              checklist_item_with_entity_dto:
                              ChecklistItemWithEntityDTO):
        checklist_item_text = checklist_item_with_entity_dto.text
        ...
        checklist_item_id = self.checklist_storage.create_checklist_item(
    ...
    def _get_or_create_checklist_for_given_entity_details(
            self, entity_id: str, entity_type: EntityType) -> str:
        from ib_utility_tools.interactors.storage_interfaces.dtos import \
            EntityDTO
        entity_dto = EntityDTO(entity_id=entity_id, entity_type=entity_type)
        checklist_id = \
            self.checklist_storage.get_checklist_id_if_exists(
