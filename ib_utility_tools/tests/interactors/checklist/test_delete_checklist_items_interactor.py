...
class TestDeleteChecklistItemsInteractor:
    ...
    def presenter_mock(self):
        ...
        return mock.create_autospec(DeleteChecklistItemsPresenterInterface)

    @pytest.fixture()
    def interactor(self, storage_mock):
        from ib_utility_tools.interactors.delete_checklist_items_interactor \
            import DeleteChecklistItemsInteractor
        return DeleteChecklistItemsInteractor(checklist_storage=storage_mock)
    ...
    def test_valid_item_ids_returns_success_response(
        ...
        storage_mock.get_valid_checklist_item_ids.return_value = \
            checklist_item_ids
    ...
    def test_given_duplicate_item_ids_then_raise_duplicate_item_ids_response(
        ...
        # Assert
        presenter_mock.get_response_for_duplicate_checklist_item_ids_exception \
    ...
    def test_given_invalid_item_ids_then_raise_invalid_item_ids_response(
        ...
        presenter_mock.get_response_for_invalid_checklist_item_ids_exception \
            .return_value = mock.Mock()
