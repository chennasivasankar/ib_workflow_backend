...
STATICFILES_STORAGE = 'ib_workflows_backend.common.aws.custom_storages.StaticStorage'
DEFAULT_FILE_STORAGE = 'ib_workflows_backend.common.aws.custom_storages.MediaStorage'
