...
class GetReferralCodeResponseType(object):
    def __init__(self, referral_code=None,  **kwargs):
...
class GetReferralCodeResponseSerializer(serializers.Serializer):
    referral_code = serializers.CharField(required=False, allow_blank=True, allow_null=True)

    def create(self, validated_data):
        return GetReferralCodeResponseType(**validated_data)
