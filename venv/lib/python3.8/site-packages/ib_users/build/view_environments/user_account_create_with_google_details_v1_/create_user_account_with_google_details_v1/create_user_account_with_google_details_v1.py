...
app_name = "ib_users"
operation_id  = "create_user_account_with_google_details_v1"
group_name = ""

@request_response(options=options, app_name=app_name, operation_id=operation_id, group_name=group_name)
def create_user_account_with_google_details_v1(request, *args, **kwargs):
    args = (request,) + args
    from django_swagger_utils.drf_server.wrappers.view_env_wrapper import view_env_wrapper
    return view_env_wrapper(app_name, "create_user_account_with_google_details_v1", group_name, *args, **kwargs)
