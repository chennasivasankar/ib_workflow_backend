...
from ib_users.build.view_environments.referral_link_v1_.referral_link.link_with_referrer.link_with_referrerSerializer import link_with_referrerSerializer
...
options = {
    ...
    'REQUEST_SERIALIZER': link_with_referrerSerializer,
