...
class Status_200Type(object):
    def __init__(self, is_default_password_changed=None,  **kwargs):
        self.is_default_password_changed = is_default_password_changed
...
class Status_200Serializer(serializers.Serializer):
    is_default_password_changed = serializers.NullBooleanField(required=False)
