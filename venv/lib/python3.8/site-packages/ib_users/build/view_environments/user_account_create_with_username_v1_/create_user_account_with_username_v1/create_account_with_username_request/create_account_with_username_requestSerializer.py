...
class create_account_with_username_requestType(object):
...
class create_account_with_username_requestSerializer(serializers.Serializer):
    username = serializers.CharField()
    password = serializers.CharField(required=False, allow_blank=True, allow_null=True)

    def create(self, validated_data):
        return create_account_with_username_requestType(**validated_data)
