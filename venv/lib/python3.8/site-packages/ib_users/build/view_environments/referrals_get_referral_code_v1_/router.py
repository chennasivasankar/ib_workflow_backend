path_method_dict = {
    "referrals/get_referral_code/v1/": {
        "POST": "get_referral_code"
    }
}


def referrals_get_referral_code_v1_(request, *args, **kwargs):
    ...
    response = router_wrapper("ib_users", "referrals_get_referral_code_v1_", operations_dict, request, *args, **kwargs)
    return response