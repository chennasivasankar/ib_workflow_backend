...
from ib_users.build.responses.GetReferralCodeResponse.GetReferralCodeResponse.GetReferralCodeResponseSerializer import GetReferralCodeResponseSerializer
...
options = {
    ...
    'REQUEST_SERIALIZER': UserIdSerializer,
    'REQUEST_SERIALIZER_MANY_ITEMS': False,
    'RESPONSE': {
        
        '200' : {
           'RESPONSE_SERIALIZER': GetReferralCodeResponseSerializer,
...
def get_referral_code(request, *args, **kwargs):
    args = (request,) + args
    from django_swagger_utils.drf_server.wrappers.view_env_wrapper import view_env_wrapper
    return view_env_wrapper(app_name, "get_referral_code", group_name, *args, **kwargs)
