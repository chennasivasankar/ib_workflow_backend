...
from ib_users.build.view_environments.send_otp_to_user_with_email_v1_.send_otp_to_user_with_email_v1.SendOTPToEmailParameters.SendOTPToEmailParametersSerializer import SendOTPToEmailParametersSerializer
...
options = {
    ...
    'REQUEST_SERIALIZER': SendOTPToEmailParametersSerializer,
