...
from ib_users.build.serializers.definitions.BaseUserProfile.BaseUserProfileSerializer import BaseUserProfileSerializer
from ib_users.build.serializers.definitions.UserProfileWithID.UserProfileWithIDSerializer import UserProfileWithIDSerializer
...
options = {
    ...
    'REQUEST_SERIALIZER': BaseUserProfileSerializer,
    'REQUEST_SERIALIZER_MANY_ITEMS': False,
    'RESPONSE': {
        
        '200' : {
           'RESPONSE_SERIALIZER': UserProfileWithIDSerializer,
...
def update_user_profile(request, *args, **kwargs):
    ...
    return view_env_wrapper(app_name, "update_user_profile", group_name, *args, **kwargs)
