path_method_dict = {
    "user_profile/update/v1/": {
        "POST": "update_user_profile"
    }
}


def user_profile_update_v1_(request, *args, **kwargs):
    ...
    response = router_wrapper("ib_users", "user_profile_update_v1_", operations_dict, request, *args, **kwargs)
    return response