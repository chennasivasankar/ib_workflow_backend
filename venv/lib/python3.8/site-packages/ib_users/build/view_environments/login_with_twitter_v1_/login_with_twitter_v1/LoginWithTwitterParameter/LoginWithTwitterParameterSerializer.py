...
class LoginWithTwitterParameterType(object):
...
class LoginWithTwitterParameterSerializer(serializers.Serializer):
    twitter_access_token = serializers.CharField()
    twitter_secret_token = serializers.CharField()

    def create(self, validated_data):
        return LoginWithTwitterParameterType(**validated_data)
