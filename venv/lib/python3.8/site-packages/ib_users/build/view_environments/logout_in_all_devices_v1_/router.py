path_method_dict = {
    "logout_in_all_devices/v1/": {
        "POST": "logout_in_all_devices_v1"
    }
}


def logout_in_all_devices_v1_(request, *args, **kwargs):
    ...
    response = router_wrapper("ib_users", "logout_in_all_devices_v1_", operations_dict, request, *args, **kwargs)
    return response