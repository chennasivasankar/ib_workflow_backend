...
from ib_users.build.view_environments.user_account_verify_reset_password_otp_given_username_v1_.verify_reset_password_otp_given_username_v1.VerifyResetPasswordOTPGivenUsernameParameter.VerifyResetPasswordOTPGivenUsernameParameterSerializer import VerifyResetPasswordOTPGivenUsernameParameterSerializer
...
options = {
    ...
    'REQUEST_SERIALIZER': VerifyResetPasswordOTPGivenUsernameParameterSerializer,
...
app_name = "ib_users"
operation_id  = "verify_reset_password_otp_given_username_v1"
group_name = ""

@request_response(options=options, app_name=app_name, operation_id=operation_id, group_name=group_name)
def verify_reset_password_otp_given_username_v1(request, *args, **kwargs):
    args = (request,) + args
    from django_swagger_utils.drf_server.wrappers.view_env_wrapper import view_env_wrapper
    return view_env_wrapper(app_name, "verify_reset_password_otp_given_username_v1", group_name, *args, **kwargs)
