...
class LoginWithPhoneNumberAndOTPParameterType(object):
    def __init__(self, phone_number, country_code, otp,  **kwargs):
...
class LoginWithPhoneNumberAndOTPParameterSerializer(serializers.Serializer):
    phone_number = serializers.CharField()
    country_code = serializers.CharField()
    otp = serializers.CharField()

    def create(self, validated_data):
        return LoginWithPhoneNumberAndOTPParameterType(**validated_data)
