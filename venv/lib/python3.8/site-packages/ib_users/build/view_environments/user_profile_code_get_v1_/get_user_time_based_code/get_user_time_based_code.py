...
from ib_users.build.responses.GetUserCodeResponse.GetUserCodeResponse.GetUserCodeResponseSerializer import GetUserCodeResponseSerializer
...
options = {
    ...
    'RESPONSE': {
        ...
        '200' : {
           'RESPONSE_SERIALIZER': GetUserCodeResponseSerializer,
