...
from ib_users.build.view_environments.user_account_link_google_v1_.link_google.link_google_account_request.link_google_account_requestSerializer import link_google_account_requestSerializer
...
options = {
    ...
    'REQUEST_SERIALIZER': link_google_account_requestSerializer,
...
def link_google(request, *args, **kwargs):
    args = (request,) + args
    from django_swagger_utils.drf_server.wrappers.view_env_wrapper import view_env_wrapper
    return view_env_wrapper(app_name, "link_google", group_name, *args, **kwargs)
