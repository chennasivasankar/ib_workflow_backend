...
class link_google_account_requestType(object):
    def __init__(self, google_access_token,  **kwargs):
...
class link_google_account_requestSerializer(serializers.Serializer):
    google_access_token = serializers.CharField()

    def create(self, validated_data):
        return link_google_account_requestType(**validated_data)
