path_method_dict = {
    "user_account/link_google/v1/": {
        "POST": "link_google"
    }
}


def user_account_link_google_v1_(request, *args, **kwargs):
    ...
    response = router_wrapper("ib_users", "user_account_link_google_v1_", operations_dict, request, *args, **kwargs)
    return response