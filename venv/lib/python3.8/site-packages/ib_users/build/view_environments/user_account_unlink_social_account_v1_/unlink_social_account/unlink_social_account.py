...
from ib_users.build.view_environments.user_account_unlink_social_account_v1_.unlink_social_account.unlink_social_account_request.unlink_social_account_requestSerializer import unlink_social_account_requestSerializer
...
options = {
    ...
    'REQUEST_SERIALIZER': unlink_social_account_requestSerializer,
...
def unlink_social_account(request, *args, **kwargs):
    args = (request,) + args
    from django_swagger_utils.drf_server.wrappers.view_env_wrapper import view_env_wrapper
    return view_env_wrapper(app_name, "unlink_social_account", group_name, *args, **kwargs)
