...
class change_username_requestType(object):
    def __init__(self, new_username,  **kwargs):
...
class change_username_requestSerializer(serializers.Serializer):
    new_username = serializers.CharField()

    def create(self, validated_data):
        return change_username_requestType(**validated_data)
