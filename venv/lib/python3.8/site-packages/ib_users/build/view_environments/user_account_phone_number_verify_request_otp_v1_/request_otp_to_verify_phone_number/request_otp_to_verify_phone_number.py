...
app_name = "ib_users"
operation_id  = "request_otp_to_verify_phone_number"
group_name = ""

@request_response(options=options, app_name=app_name, operation_id=operation_id, group_name=group_name)
def request_otp_to_verify_phone_number(request, *args, **kwargs):
    args = (request,) + args
    from django_swagger_utils.drf_server.wrappers.view_env_wrapper import view_env_wrapper
    return view_env_wrapper(app_name, "request_otp_to_verify_phone_number", group_name, *args, **kwargs)
