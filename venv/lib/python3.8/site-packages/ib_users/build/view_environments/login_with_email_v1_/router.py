path_method_dict = {
    "login_with_email/v1/": {
        "POST": "login_with_email_v1"
    }
}


def login_with_email_v1_(request, *args, **kwargs):
    ...
    response = router_wrapper("ib_users", "login_with_email_v1_", operations_dict, request, *args, **kwargs)
    return response