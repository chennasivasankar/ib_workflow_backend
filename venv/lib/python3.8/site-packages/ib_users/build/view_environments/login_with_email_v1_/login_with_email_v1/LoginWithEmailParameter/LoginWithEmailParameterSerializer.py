...
class LoginWithEmailParameterType(object):
...
class LoginWithEmailParameterSerializer(serializers.Serializer):
    email = serializers.CharField()
    password = serializers.CharField()

    def create(self, validated_data):
        return LoginWithEmailParameterType(**validated_data)
