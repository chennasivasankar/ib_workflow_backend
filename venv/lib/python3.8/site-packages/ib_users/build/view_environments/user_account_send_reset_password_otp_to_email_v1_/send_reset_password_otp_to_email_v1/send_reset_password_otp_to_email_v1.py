...
app_name = "ib_users"
operation_id  = "send_reset_password_otp_to_email_v1"
group_name = ""

@request_response(options=options, app_name=app_name, operation_id=operation_id, group_name=group_name)
def send_reset_password_otp_to_email_v1(request, *args, **kwargs):
    args = (request,) + args
    from django_swagger_utils.drf_server.wrappers.view_env_wrapper import view_env_wrapper
    return view_env_wrapper(app_name, "send_reset_password_otp_to_email_v1", group_name, *args, **kwargs)
