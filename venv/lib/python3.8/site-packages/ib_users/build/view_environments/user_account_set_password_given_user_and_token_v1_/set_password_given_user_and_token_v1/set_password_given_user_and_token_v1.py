...
from ib_users.build.view_environments.user_account_set_password_given_user_and_token_v1_.set_password_given_user_and_token_v1.set_password_request.set_password_requestSerializer import set_password_requestSerializer
...
options = {
    ...
    'REQUEST_SERIALIZER': set_password_requestSerializer,
...
app_name = "ib_users"
operation_id  = "set_password_given_user_and_token_v1"
group_name = ""

@request_response(options=options, app_name=app_name, operation_id=operation_id, group_name=group_name)
def set_password_given_user_and_token_v1(request, *args, **kwargs):
    args = (request,) + args
    from django_swagger_utils.drf_server.wrappers.view_env_wrapper import view_env_wrapper
    return view_env_wrapper(app_name, "set_password_given_user_and_token_v1", group_name, *args, **kwargs)
