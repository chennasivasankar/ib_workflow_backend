...
from ib_users.build.view_environments.user_account_link_twitter_v1_.link_twitter.link_twitter_account_request.link_twitter_account_requestSerializer import link_twitter_account_requestSerializer
...
options = {
    ...
    'REQUEST_SERIALIZER': link_twitter_account_requestSerializer,
