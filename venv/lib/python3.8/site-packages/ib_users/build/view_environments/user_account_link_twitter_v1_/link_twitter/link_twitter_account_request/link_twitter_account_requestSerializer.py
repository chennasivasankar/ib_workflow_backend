...
class link_twitter_account_requestType(object):
    def __init__(self, twitter_access_token, twitter_secret_token,  **kwargs):
        self.twitter_access_token = twitter_access_token
        self.twitter_secret_token = twitter_secret_token
...
class link_twitter_account_requestSerializer(serializers.Serializer):
    twitter_access_token = serializers.CharField()
    twitter_secret_token = serializers.CharField()

    def create(self, validated_data):
        return link_twitter_account_requestType(**validated_data)
