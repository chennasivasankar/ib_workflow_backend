...
class link_facebook_account_requestType(object):
    def __init__(self, facebook_access_token,  **kwargs):
...
class link_facebook_account_requestSerializer(serializers.Serializer):
    facebook_access_token = serializers.CharField()

    def create(self, validated_data):
        return link_facebook_account_requestType(**validated_data)
