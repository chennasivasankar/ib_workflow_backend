...
class LogoutFromADeviceParametersType(object):
...
class LogoutFromADeviceParametersSerializer(serializers.Serializer):
    device_id = serializers.CharField()

    def create(self, validated_data):
        return LogoutFromADeviceParametersType(**validated_data)
