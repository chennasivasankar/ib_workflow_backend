...
class LoginWithUsernameParameterType(object):
...
class LoginWithUsernameParameterSerializer(serializers.Serializer):
    username = serializers.CharField()
    password = serializers.CharField()

    def create(self, validated_data):
        return LoginWithUsernameParameterType(**validated_data)
