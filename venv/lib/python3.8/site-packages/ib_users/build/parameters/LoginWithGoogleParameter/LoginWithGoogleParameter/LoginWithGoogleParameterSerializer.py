...
class LoginWithGoogleParameterType(object):
...
class LoginWithGoogleParameterSerializer(serializers.Serializer):
    google_access_token = serializers.CharField()

    def create(self, validated_data):
        return LoginWithGoogleParameterType(**validated_data)
