...
class LoginWithEmailAndOTPParameterType(object):
    def __init__(self, email, otp,  **kwargs):
        self.email = email
        self.otp = otp
...
class LoginWithEmailAndOTPParameterSerializer(serializers.Serializer):
    email = serializers.CharField()
    otp = serializers.CharField()

    def create(self, validated_data):
        return LoginWithEmailAndOTPParameterType(**validated_data)
