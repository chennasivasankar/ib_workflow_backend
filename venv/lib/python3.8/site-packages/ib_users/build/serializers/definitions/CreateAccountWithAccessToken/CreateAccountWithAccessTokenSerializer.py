...
class CreateAccountWithAccessTokenType(object):
...
class CreateAccountWithAccessTokenSerializer(serializers.Serializer):
    access_token = serializers.CharField()

    def create(self, validated_data):
        return CreateAccountWithAccessTokenType(**validated_data)
