...
class TestUtils:
    ...
    def make_api_call(self, body, url, query_params, header_params):
        ...
        response = self._make_api_call_based_on_api_request_method(
            api_client=api_client, url=url, body=body,
            header_params=header_params)
        return response

    def _make_api_call_based_on_api_request_method(
        self, api_client, url, body, header_params):
        import json
    ...
    def default_test_case(self, body=None, query_params=None, path_params=None,
