...
class AddProjectPresenterImplementation(
    AddProjectPresenterInterface, HTTPResponseMixin
):
    ...
    def response_for_project_display_id_already_exists_exception(self):
        ...
        response_dict = {
            "response": PROJECT_DISPLAY_ID_ALREADY_EXISTS[0],
            "http_status_code": StatusCode.BAD_REQUEST.value,
