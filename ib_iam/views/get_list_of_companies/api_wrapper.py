...
def api_wrapper(*args, **kwargs):
    ...
    try:
        from ib_iam.views.get_list_of_companies.request_response_mocks \
    ...
    test_case = {
        "path_params": {},
        "query_params": {'limit_query_parameter': 5, 'offset_query_parameter': 752},
        "header_params": {},
        "body": body,
    ...
    try:
        response = ''
        status_code = 200
        if '200' in ['200', '400', '401']:
            from ib_iam.views.get_list_of_companies.request_response_mocks \
                import RESPONSE_200_JSON
            response = RESPONSE_200_JSON
            status_code = 200
        elif '201' in ['200', '400', '401']:
            from ib_iam.views.get_list_of_companies.request_response_mocks \
