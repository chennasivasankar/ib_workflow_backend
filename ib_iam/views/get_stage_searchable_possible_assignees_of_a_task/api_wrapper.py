...
def api_wrapper(*args, **kwargs):
    ...
    try:
        from ib_iam.views.get_stage_searchable_possible_assignees_of_a_task.request_response_mocks \
    ...
    test_case = {
        "path_params": {'stage_id': 40},
        "query_params": {'limit': 166, 'offset': 140, 'search_query': 'string'},
        "header_params": {},
        "body": body,
