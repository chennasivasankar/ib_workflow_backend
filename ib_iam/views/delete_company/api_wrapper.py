...
def api_wrapper(*args, **kwargs):
    ...
    try:
        from ib_iam.views.delete_company.request_response_mocks \
    ...
    test_case = {
        "path_params": {'company_id': '4d4146a8-284d-465e-8bc6-fe090e3e2e75'},
        "query_params": {},
        "header_params": {},
        "body": body,
    ...
    try:
        response = ''
        status_code = 200
        if '200' in ['200', '404', '401']:
            from ib_iam.views.delete_company.request_response_mocks \
                import RESPONSE_200_JSON
            response = RESPONSE_200_JSON
            status_code = 200
        elif '201' in ['200', '404', '401']:
            from ib_iam.views.delete_company.request_response_mocks \
