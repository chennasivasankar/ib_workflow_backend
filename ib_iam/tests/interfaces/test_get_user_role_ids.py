...
class TestGetUserRoleIds:
    ...
    def test_get_user_role_ids(self):
        # Arrange
        expected_role_ids = [
            UUID('c953895a-b77b-4a60-b94d-e4ee6a9b8c3a'),
            UUID('904c2d9f-8985-454f-a504-eb39482315c0'),
            UUID('735bbec1-2054-4860-80fa-1af3f6458df3'),
            UUID('12832ab6-100e-4d8e-b3a3-f3e0c6aa65f6'),
            UUID('96040b6e-c8e5-46ab-a313-5e3fc083776b')
        ]
