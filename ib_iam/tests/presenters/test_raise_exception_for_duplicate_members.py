...
from ib_iam.constants.exception_messages import DUPLICATE_MEMBERS
...
class TestRaiseExceptionForDuplicateMembers:
    def test_when_it_is_called_it_returns_http_response(self):
        ...
        import json
        expected_response = DUPLICATE_MEMBERS[0]
        expected_res_status = DUPLICATE_MEMBERS[1]
        expected_http_status_code = 400

        result = json_presenter.raise_exception_for_duplicate_members()
