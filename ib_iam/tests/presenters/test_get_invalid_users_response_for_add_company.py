...
from ib_iam.constants.exception_messages import INVALID_USERS_FOR_ADD_COMPANY


class TestRaiseExceptionForInvalidUsersForAddCompany:
    def test_whether_it_returns_invalid_users_http_response(self):
        json_presenter = AddCompanyPresenterImplementation()
        expected_response = INVALID_USERS_FOR_ADD_COMPANY[0]
        expected_res_status = INVALID_USERS_FOR_ADD_COMPANY[1]
