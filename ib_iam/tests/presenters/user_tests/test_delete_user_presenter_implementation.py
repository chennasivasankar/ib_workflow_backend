...
class TestDeleteUserPresenter:
    ...
    def presenter(self):
        ...
        return DeleteUserPresenterImplementation()
    ...
    def test_raise_user_is_not_admin_exception(
            self, presenter
    ):
        # Arrange
    ...
    def test_raise_user_is_not_found_exception(
            self, presenter
    ):
        # Arrange
        from ib_iam.constants.exception_messages import \
    ...
    def test_raise_user_does_not_have_delete_permission_exception(
            self, presenter
    ):
        # Arrange
        from ib_iam.constants.exception_messages import \
