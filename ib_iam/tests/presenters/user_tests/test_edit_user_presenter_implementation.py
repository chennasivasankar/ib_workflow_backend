...
class TestEditUserPresenter:
    ...
    def presenter(self):
        ...
        return EditUserPresenterImplementation()

    def test_edit_user_response_successful_returns_success_response(
            self, presenter
    ):
        # Arrange
    ...
    def test_raise_invalid_company_id_exception(
            self, presenter
    ):
        # Arrange
    ...
    def test_raise_invalid_team_ids_exception(
            self, presenter
    ):
        # Arrange
    ...
    def test_raise_user_does_not_exist_exception(
            self, presenter
    ):
        # Arrange
