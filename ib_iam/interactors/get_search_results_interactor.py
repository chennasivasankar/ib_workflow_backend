...
class GetSearchResultsInteractor:
    ...
    def search_users_results(self, offset: int,
                             limit: int,
    ...
    def search_countries_results(self, offset: int,
                                 limit: int,
                                 search_query: str
    ...
    def search_states_results(self, offset: int,
                              limit: int,
                              search_query: str
    ...
    def search_cities_results(self, offset: int,
                              limit: int,
                              search_query: str
                              ) -> List[ElasticCityDTO]:
