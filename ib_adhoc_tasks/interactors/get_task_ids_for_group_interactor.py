from ib_adhoc_tasks.interactors.dtos import ApplyGroupByDTO, TaskIdsAndCountDTO
...
class GetTaskIdsForGroupInteractor:
    ...
    def get_task_ids_for_groups(
            self, apply_groupby_dto: ApplyGroupByDTO,
    ) -> TaskIdsAndCountDTO:
        self._validate_project_id(project_id=apply_groupby_dto.project_id)
        self._validate_template_id(template_id=apply_groupby_dto.template_id)
